  ...
  return (
    ...
    >
      <Link
        ...
        className="group -mx-[clamp(8px,1vw,16px)] grid grid-cols-1 items-baseline gap-x-[clamp(20px,2.4vw,44px)] gap-y-2.5 px-[clamp(8px,1vw,16px)] py-[clamp(14px,1.5vw,20px)] transition-colors hover:bg-bone tab:[grid-template-columns:minmax(0,1fr)_minmax(0,8rem)_minmax(0,11rem)_auto]"
      >
        ...
        */}
        ...
        <span
          aria-hidden
          className="hidden text-[15px] text-clay-300 transition-[color,transform] duration-300 group-hover:translate-x-1.5 group-hover:text-sage-600 tab:block"
        >
          →
        </span>
      </Link>
