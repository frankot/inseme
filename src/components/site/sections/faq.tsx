            ...
            return (
              ...
              >
                ...
                {open && (
                  ...
                  <div
                    className="reveal-shown max-w-[38em] text-pretty pr-[clamp(24px,3vw,60px)] pb-[clamp(22px,2.2vw,28px)] text-[15.5px] leading-[1.75] text-ink-400 [&_a]:text-sage-600 [&_a]:underline [&_a]:underline-offset-2 [&_li]:mt-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_p+p]:mt-3 [&_strong]:text-ink-900 [&_ul]:list-disc [&_ul]:pl-5"
